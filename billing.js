// Coolbuy — Play Billing (Digital Goods API) + paywall. Loaded after the app.
(function(){'use strict';
const CFG={"key":"cb_ent","event":"coolbuy-pro-changed","app":"Coolbuy","accent":"#3E5C76","bg":"#F8F5EF","p1":"#EFEADD","line":"#E5DFD2","ink":"#232A33","mut":"#75808C","title":"Lock unlimited purchases","sub":"Track every urge you're cooling off on, not just one at a time.","benefits":["<b>Unlimited items</b> in cooldown at once","Choose your lock length — 24h, 72h, or a full week","See your full skip history and total saved, forever"],"plans":[{"key":"pro_yearly","name":"Annual","price":"$19.99","per":"/yr","tag":"Cancel anytime","hero":true},{"key":"pro_weekly","name":"Weekly","price":"$2.99","per":"/wk","tag":"No commitment"}],"grants":{"pro_yearly":"pro","pro_weekly":"pro"}};
